...
public class TC_004 extends DriverInstance {
	...
	@Test(priority = 0)
	private void TC_004() throws InterruptedException {
...
// --------------------------------------------------------------------------------------------------->> Next here
		...
		P2_Login.getE_Login_email().sendKeys("Xuan001@gmail.com");
		P2_Login.getE_Login_password().sendKeys("Matkhau1@");
		P2_Login.getE_Login_submit().click();
		P0_Menu.getE_Logout().click();
		assertEquals(driver.getTitle().contains("Automation Exercise - Signup / Login"), true);
