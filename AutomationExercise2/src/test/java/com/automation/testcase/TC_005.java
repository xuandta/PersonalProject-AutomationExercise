...
public class TC_005 extends DriverInstance{
	...
	@Test(priority = 0)
	private void TC005() throws InterruptedException {
...
// --------------------------------------------------------------------------------------------------->> Next here
		...
		P2_Login.fullfill_form_sign_up("xuan01", "xuan01@gmail.com");
		assertEquals(P2_Login.E_msg_Email_Address_already_exist .isDisplayed(), true);
	}
