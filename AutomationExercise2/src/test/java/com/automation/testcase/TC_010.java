...
public class TC_010 extends DriverInstance{
	...
	@Test(priority = 0)
	private void TC010() throws InterruptedException {
...
// --------------------------------------------------------------------------------------------------->> Next here
		...
		assertEquals(P0_Menu.getE_Footer_Subscription().isDisplayed(), true);
		P0_Menu.FullFill_Footer_Subcribe("abc@gmail.com");
		assertEquals(P0_Menu.getE_msg_You_have_been_successfully_subscribed().isDisplayed(), true);
		}
