...
public class TC_015 extends DriverInstance{
	...
	@Test(priority = 0)
	private void TC015() throws InterruptedException {
...
//		assertEquals(P0_Menu.E_Logged_in_as.isDisplayed(), true);
		...
		Thread.sleep(2000);
		P5_AfterSignup.getE_button_continue().click();Thread.sleep(2000);
		action.A_Frame_closeAds();Thread.sleep(2000);
