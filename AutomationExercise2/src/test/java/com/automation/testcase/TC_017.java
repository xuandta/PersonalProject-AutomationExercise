...
public class TC_017 extends DriverInstance{
	...
	@Test(priority = 0)
	private void TC017() throws InterruptedException {
...
// --------------------------------------------------------------------------------------------------->> Next here
		...
		assertEquals(driver.getTitle().equals(P4_Cart.getTitle()), true);
		P4_Cart.getLE_deleteProduct().get(0).click();
		assertEquals(P4_Cart.getE_msg_Cart_is_empty().isDisplayed(),true);
