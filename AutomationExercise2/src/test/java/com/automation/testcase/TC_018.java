...
public class TC_018 extends DriverInstance{
	...
	@Test(priority = 0)
	private void TC018() throws InterruptedException {
...
// --------------------------------------------------------------------------------------------------->> Next here
		...
		assertEquals(P3_Products.getE_left_sidebar().isDisplayed(),true,"message 02");
		P3_Products.getLE_CATEGORIES().get(0).click(); 
		P3_Products.getLE_CATEGORIES_WOMAN_SUB().get(1).click();action.A_Frame_closeAds();
		assertEquals(driver.getCurrentUrl().contains(P3_Products.URL_category_products()),true,"message 03");
		assertEquals(P3_Products.getE_title_text_center().isDisplayed(), true,"message 04");
		P3_Products.getLE_CATEGORIES2().get(1).click();
		P3_Products.getLE_CATEGORIES_MEN_SUB().get(0).click();
		assertEquals(driver.getTitle(), "Automation Exercise - Tshirts Products","message 05");
