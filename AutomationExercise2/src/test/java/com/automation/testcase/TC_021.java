...
public class TC_021 extends DriverInstance{
	...
	@Test(priority = 0)
	private void TC021() throws InterruptedException {
...
// --------------------------------------------------------------------------------------------------->> Next here
		...
		assertEquals(P3_1_ProductDetail.getE_Write_Your_Review().isDisplayed(), true,"msg 03");
		P3_1_ProductDetail.fullfillform("Xuân", "xuan@gmail.com", "This is a \n sample review");
		assertEquals(P3_1_ProductDetail.getE_msg_Thank_you_for_your_review().isDisplayed(), true);
