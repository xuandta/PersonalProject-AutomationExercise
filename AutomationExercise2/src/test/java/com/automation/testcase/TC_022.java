...
public class TC_022 extends DriverInstance{
...
// --------------------------------------------------------------------------------------------------->> Next here
		...
		assertEquals(P3_Products.getE_RECOMMENDED_ITEMS().isDisplayed() , true,"message 02");
		String name = P3_Products.getE_RECOMMENDED_ITEMS_ProductName().get(3).getText(); System.out.println("pass 01");
		P3_Products.getE_RECOMMENDED_ITEMS_ADDTOCART().get(3).click();System.out.println("pass 02");
		P3_Products.getE_ViewCart().click();
		assertEquals(P4_Cart.getLE_NameProduct().get(0).getText(), name, "message 03");
