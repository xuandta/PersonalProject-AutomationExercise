...
public class TC_024 extends DriverInstance{
...
// --------------------------------------------------------------------------------------------------->> Next here
		...
		P4_1_CheckOut.getE_message().sendKeys("This is a \n message sample");
		P4_1_CheckOut.getE_Place_Order().click();
		P4_2_Payment.FullFillForm("NameonCard", "11111111111", "041", "03", "2022");
		assertEquals(P4_2_Payment.getE_msg_Congratulations_Your_order_has_sbeen_confirmed().isDisplayed(), true);
		P4_2_Payment.getE_Download_Invoice().click();
		Thread.sleep(2000); 
		assertEquals(action.isFileDownloaded("C:\\Users\\Admin\\Downloads", "invoice.txt"), true);
		P4_2_Payment.getE_continue().click();
