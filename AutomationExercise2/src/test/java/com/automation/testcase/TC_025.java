...
public class TC_025 extends DriverInstance{
...
//		action.A_JS_ScrollAndClick();
		JavascriptExecutor js = (JavascriptExecutor)driver;
//	    js.executeScript("arguments[0].scrollIntoView(true);", P0_Menu.getE_arrow_PageUp());
		js.executeScript("window.scrollTo(0,document.body.scrollHeight)");
	    Thread.sleep(1000);
		js.executeScript("arguments[0].click();", P0_Menu.getE_arrow_PageUp());
